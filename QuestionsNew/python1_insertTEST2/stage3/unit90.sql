...
-- Generated at 2025-12-24 23:26:01
...
b',
    JSON_ARRAY('a
b'),
    '{"segments": [{"type": "code_inline", "parts": [{"type": "code", "value": "lines=[input() for _ in range("}, {"type": "slot", "index": 0}, {"type": "code", "value": ")]"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "print(\"\\n\".join(lines))"}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
    'join 用于高效合并多个字符串片段。',
    '"\n".join(lines)'
...
VALUES (
    ...
    '6',
    JSON_ARRAY('4'),
    '{"segments": [{"type": "code_inline", "parts": [{"type": "code", "value": "n=int(input())"}, {"type": "slot", "index": 0}, {"type": "code", "value": ""}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "cnt=0"}, {"type": "code_line", "value": "for i in range(1,n+1):"}, {"type": "code_line", "value": "    if n%i==0:"}, {"type": "code_line", "value": "        cnt+=1"}, {"type": "code_line", "value": "print(cnt)"}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
    '枚举所有可能因子并计数。',
    'divisors loop'
...
VALUES (
    ...
    'hello',
    JSON_ARRAY('2'),
    '{"segments": [{"type": "code_inline", "parts": [{"type": "code", "value": "s=input().lower()"}, {"type": "slot", "index": 0}, {"type": "code", "value": ""}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "print(sum(1 for ch in s if ch in \"aeiou\"))"}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
...
VALUES (
    ...
    'a b a',
    JSON_ARRAY('a 2', 'b 1'),
    '{"segments": [{"type": "code_inline", "parts": [{"type": "code", "value": "from collections import Counter"}, {"type": "slot", "index": 0}, {"type": "code", "value": ""}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "print(*Counter(input().split()).items())"}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
...
VALUES (
    ...
    NULL,
    JSON_ARRAY('(none)'),
    '{"segments": [{"type": "code_inline", "parts": [{"type": "code", "value": "# 建议：算法与数据结构进阶、系统设计、并发与性能调优"}, {"type": "slot", "index": 0}, {"type": "code", "value": ""}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
