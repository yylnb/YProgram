USE `questions`;
-- Unit 52 | Start ID: 766
-- Generated at 2025-12-24 23:15:04
...
VALUES (
    ...
    'username=""',
    JSON_ARRAY('error'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "username = input().strip()"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "if not username:"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "    print(\"error\")"}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
    '先去除空白并判断是否为空字符串。',
...
VALUES (
    ...
    'p="abc123"',
    JSON_ARRAY('ok'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "p = input()"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "if len(p) >= 6:"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "    print(\"ok\")"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "else:"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "    print(\"short\")"}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
    '基本密码策略要求最低长度，作为初级校验。',
    'if len(p)<6: ...'
...
VALUES (
    ...
    'u=admin p=123456',
    JSON_ARRAY('success'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "u = input().strip()"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "p = input().strip()"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "if u==\"admin\" and p==\"123456\":"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "    print(\"success\")"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "else:"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "    print(\"fail\")"}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
...
VALUES (
    ...
    's=" admin "',
    JSON_ARRAY('admin'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "s = input()"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "print(s.strip())"}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
...
VALUES (
    ...
    NULL,
    JSON_ARRAY(),
    '{"segments": [{"type": "code_inline", "parts": [{"type": "code", "value": "if check(u,p):"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "    print(\"token_123\")"}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
    '示例中直接打印 token，演示思路。',
    '返回 JSON 包含 token'
...
VALUES (
    ...
    NULL,
    JSON_ARRAY(),
    '{"segments": [{"type": "code_inline", "parts": [{"type": "code", "value": "print(\"用户名或密码错误\")"}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
    '使用通用错误信息可以避免信息泄露。',
