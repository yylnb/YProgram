...
-- Generated at 2025-12-24 23:41:53
...
VALUES (
    ...
    NULL,
    JSON_ARRAY(),
    '{"segments": [{"type": "code_inline", "parts": [{"type": "code", "value": "with open(\"a.txt\") as f:"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "    for line in f:"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "        print(line)"}]}]}',
...
VALUES (
    ...
    NULL,
    JSON_ARRAY(),
    '{"segments": [{"type": "code_inline", "parts": [{"type": "code", "value": "with open(\"a.bin\", \""}, {"type": "slot", "index": 0}, {"type": "code", "value": "\") as f:"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "    b = f.read()"}]}]}',
    JSON_ARRAY('b', 't', 'r', 'w'),
    JSON_ARRAY(1),
    'b 表示二进制模式，t 表示文本（默认）。',
    ''
...
VALUES (
    ...
    NULL,
    JSON_ARRAY(),
    '{"segments": [{"type": "code_inline", "parts": [{"type": "code", "value": "with open(\"a.txt\",\"r\", encoding=\""}, {"type": "slot", "index": 0}, {"type": "code", "value": "\") as f:"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "    data = f.read()"}]}]}',
...
VALUES (
    ...
    NULL,
    JSON_ARRAY(),
    '{"segments": [{"type": "code_inline", "parts": [{"type": "code", "value": "f.write(\"a\")"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "f."}, {"type": "slot", "index": 0}, {"type": "code", "value": "()"}]}]}',
...
VALUES (
    ...
    NULL,
    JSON_ARRAY(),
    '{"segments": [{"type": "code_inline", "parts": [{"type": "code", "value": "import shutil"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "shutil."}, {"type": "slot", "index": 0}, {"type": "code", "value": "(\"a.txt\",\"b.txt\")"}]}]}',
