...
-- Generated at 2025-12-24 23:36:18
...
VALUES (
    ...
    'x = -1',
    JSON_ARRAY('None'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "def check_positive(x):"}, {"type": "code_line", "value": "    if x < 0:"}]}, {"type": "code_inline", "parts": [{"type": "slot", "index": 0}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "    return x"}]}]}',
...
VALUES (
    ...
    'x = 0',
    JSON_ARRAY('None'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "def check(x):"}, {"type": "code_line", "value": "    if x == 0:"}]}, {"type": "code_inline", "parts": [{"type": "slot", "index": 0}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "    return x"}]}]}',
...
VALUES (
    ...
    'data = []',
    JSON_ARRAY('0'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "def count_items(data):"}, {"type": "code_line", "value": "    if not data:"}]}, {"type": "code_inline", "parts": [{"type": "slot", "index": 0}, {"type": "code", "value": " 0"}]}, {"type": "code_inline", "parts": [{"type": "slot", "index": 1}, {"type": "code", "value": " len(data)"}]}]}',
