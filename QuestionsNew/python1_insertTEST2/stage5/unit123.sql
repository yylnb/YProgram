...
-- Generated at 2025-12-24 23:36:21
...
VALUES (
    ...
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "def check(n):"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "    if n < 10:"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "        "}, {"type": "slot", "index": 0}, {"type": "code", "value": ""}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "    return \"ok\""}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": ""}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "print(check(3))  # 输出 too small"}]}]}',
...
VALUES (
    ...
    NULL,
    JSON_ARRAY('None'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "def f():"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "    x=1"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": ""}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "print(f())  # 输出 "}, {"type": "slot", "index": 0}]}]}',
    JSON_ARRAY('None', '0', '1', '""'),
    JSON_ARRAY(1),
...
VALUES (
    ...
    NULL,
    JSON_ARRAY('1 2'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "def f():"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "    return 1,2"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": ""}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "a, b = "}, {"type": "slot", "index": 0}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "print(a, b)  # 1 2"}]}]}',
...
VALUES (
    ...
    NULL,
    JSON_ARRAY('3'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "def find():"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "    for i in range(5):"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "        if i==3:"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "            "}, {"type": "slot", "index": 0}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "    return -1"}]}]}',
...
VALUES (
    ...
    NULL,
    JSON_ARRAY('1'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "def outer():"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "    def inner():"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "        return 1"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "    "}, {"type": "slot", "index": 0}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": ""}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "f = outer()"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "print(f())  # 输出 1"}]}]}',
