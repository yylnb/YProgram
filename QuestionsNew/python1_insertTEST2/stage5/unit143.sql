...
-- Generated at 2025-12-24 23:41:47
...
VALUES (
    ...
    NULL,
    JSON_ARRAY(),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "import re"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "re.search(\""}, {"type": "slot", "index": 0}, {"type": "code", "value": "\", \"a.b\")"}]}]}',
    JSON_ARRAY('\.', '\d', '.', '\w'),
    JSON_ARRAY(1),
...
VALUES (
    ...
    NULL,
    JSON_ARRAY(),
    '{"segments": [{"type": "code_inline", "parts": [{"type": "code", "value": "pat = re."}, {"type": "slot", "index": 0}, {"type": "code", "value": "(\"\\\\d+\")"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "pat.findall(\"a123b\")"}]}]}',
