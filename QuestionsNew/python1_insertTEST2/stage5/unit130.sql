...
-- Generated at 2025-12-24 23:37:41
...
VALUES (
    ...
    NULL,
    JSON_ARRAY(),
    '{"segments": [{"type": "code_inline", "parts": [{"type": "code", "value": "if x<0:\n    "}, {"type": "slot", "index": 0}, {"type": "code", "value": " ValueError(\"x must be >=0\")"}]}]}',
...
VALUES (
    ...
    NULL,
    JSON_ARRAY(),
    '{"segments": [{"type": "code_inline", "parts": [{"type": "code", "value": "try:\n    pass\nexcept Exception:\n    "}, {"type": "slot", "index": 0}]}]}',
...
VALUES (
    ...
    NULL,
    JSON_ARRAY(),
    '{"segments": [{"type": "code_inline", "parts": [{"type": "code", "value": "try:\n    pass\nexcept ("}, {"type": "slot", "index": 0}, {"type": "code", "value": ") as e:\n    pass"}]}]}',
