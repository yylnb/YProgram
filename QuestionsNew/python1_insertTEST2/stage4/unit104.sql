...
-- Generated at 2025-12-24 23:30:45
...
VALUES (
    ...
    '1 2 3',
    JSON_ARRAY('1 2 3'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "lst = list(map(int, input().split()))"}, {"type": "code_line", "value": "while lst:"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "    print(lst."}, {"type": "slot", "index": 0}, {"type": "code", "value": "(0), end=\" \")"}]}]}',
...
VALUES (
    ...
    '1 2',
    JSON_ARRAY('1 2'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "from collections import deque"}, {"type": "code_line", "value": "d = deque()"}, {"type": "code_line", "value": "for x in map(int, input().split()):"}, {"type": "code_line", "value": "    d.append(x)"}, {"type": "code_line", "value": "while d:"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "    print(d."}, {"type": "slot", "index": 0}, {"type": "code", "value": "(), end=\" \")"}]}]}',
...
VALUES (
    ...
    '7 8',
    JSON_ARRAY('7 8'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "from collections import deque"}, {"type": "code_line", "value": "d = deque(map(int, input().split()))"}, {"type": "code_line", "value": "while d:"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "    print(d."}, {"type": "slot", "index": 0}, {"type": "code", "value": "(), end=\" \")"}]}]}',
...
VALUES (
    ...
    '1 2 3',
    JSON_ARRAY('3'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "stack = []"}, {"type": "code_line", "value": "for x in input().split():"}, {"type": "code_line", "value": "    stack.append(int(x))"}, {"type": "code_line", "value": "print(len(stack))"}]}]}',
    JSON_ARRAY(),
    JSON_ARRAY(),
    'append 三次后 len 返回 3。',
    'len(stack)'
