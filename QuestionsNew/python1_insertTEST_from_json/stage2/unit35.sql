...
VALUES (
    ...
    JSON_ARRAY('logged=True; is_admin=True'),
    JSON_ARRAY('Admin'),
...
VALUES (
    ...
    JSON_ARRAY('a=True;b=True;c=True'),
    JSON_ARRAY('Yes'),
...
VALUES (
    ...
    JSON_ARRAY('logged=True; is_admin=False; is_vip=True'),
    JSON_ARRAY('Allowed'),
