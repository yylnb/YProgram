...
VALUES (
    ...
    JSON_ARRAY('s = "ab-cd-ef-gh"'),
    JSON_ARRAY('aceg'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "parts = s.split(\\"-\\")"}, {"type": "code_line", "value": "joined = \\"\\".join(p[0] for p in parts)"}, {"type": "code_line", "value": "print(joined)"}, {"type": "code_line", "value": "# 请改用切片直接取得结果："}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "print(s["}, {"type": "slot", "index": 0}, {"type": "code", "value": "])"}]}]}',
