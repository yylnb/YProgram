...
VALUES (
    ...
    JSON_ARRAY('row = "apple,banana,orange"'),
...
VALUES (
    ...
    JSON_ARRAY('sentence = "good-morning to-day everyone"'),
    JSON_ARRAY('goodmorning today everyone'),
    '{"segments": [{"type": "code_inline", "parts": [{"type": "code", "value": "words = sentence."}, {"type": "slot", "index": 0}, {"type": "code", "value": "("}, {"type": "slot", "index": 3}, {"type": "code", "value": ")"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "clean = [ w."}, {"type": "slot", "index": 1}, {"type": "code", "value": "("}, {"type": "slot", "index": 4}, {"type": "code", "value": ", "}, {"type": "slot", "index": 5}, {"type": "code", "value": ") for w in words ]"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "result = "}, {"type": "slot", "index": 2}, {"type": "code", "value": " .join(clean)"}]}]}',
