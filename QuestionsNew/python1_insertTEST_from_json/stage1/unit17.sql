...
VALUES (
    ...
    '使用 find 找到关键字位置',
    '补全代码，找到子字符串第一次出现的位置。',
    JSON_ARRAY('text = "welcome to python world"'),
    JSON_ARRAY('11'),
...
VALUES (
    ...
    'replace 用于清理文本',
    '补全代码，把文本中的 "-" 替换成 空格。',
    JSON_ARRAY('s = "hello-python-world"'),
...
VALUES (
    ...
    JSON_ARRAY('msg = "system running normal"'),
    JSON_ARRAY('FOUND'),
...
VALUES (
    ...
    JSON_ARRAY('msg = "This is not good at all"'),
