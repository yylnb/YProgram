...
VALUES (
    ...
    '判断文本是否包含标记',
    '小张想判断消息中是否包含警告标记。',
    JSON_ARRAY('msg = "[Warning] Low Battery"'),
    JSON_ARRAY('True'),
...
VALUES (
    ...
    JSON_ARRAY('text = "I love programming"'),
    JSON_ARRAY('True'),
...
VALUES (
    ...
    JSON_ARRAY('parts = [\'usr\', \'local\', \'bin\']'),
...
VALUES (
    ...
    '邮箱格式简单判断',
    '补全代码，判断邮箱中是否包含 "@".',
    JSON_ARRAY('email = "user@example.com"'),
    JSON_ARRAY('True'),
...
VALUES (
    ...
    '判断文本不含敏感词',
    '补全代码，使程序输出 True。',
    JSON_ARRAY('txt = "This is a normal message"'),
    JSON_ARRAY('True'),
