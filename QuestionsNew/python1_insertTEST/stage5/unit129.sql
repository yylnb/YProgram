...
-- Generated at 2025-12-24 18:20:09
...
VALUES (
    ...
    NULL,
    JSON_ARRAY(),
    '{"segments": [{"type": "code_inline", "parts": [{"type": "code", "value": "with open(\"a.txt\",\"w\") as f:"}, {"type": "slot", "index": 0}, {"type": "code", "value": "    f.__1__(\"hello\")"}]}]}',
...
VALUES (
    ...
    NULL,
    JSON_ARRAY(),
    '{"segments": [{"type": "code_inline", "parts": [{"type": "code", "value": "with open(\"b.bin\",\""}, {"type": "slot", "index": 0}, {"type": "code", "value": "\") as f:"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "    data = f.read()"}]}]}',
