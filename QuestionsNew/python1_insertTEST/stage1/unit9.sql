USE `questions`;
-- Unit 9 | Start ID: 121
-- Generated at 2025-12-24 17:05:07
...
VALUES (
    ...
    NULL,
    JSON_ARRAY('5'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "total = 0.0"}, {"type": "code_line", "value": "for i in range(5):"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "    total = total "}, {"type": "slot", "index": 0}, {"type": "code", "value": " 1"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "print(total)"}]}]}',
