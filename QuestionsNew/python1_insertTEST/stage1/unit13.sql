...
-- Generated at 2025-12-24 17:06:44
...
VALUES (
    ...
    NULL,
    JSON_ARRAY('"Hello"'),
    '{"segments": [{"type": "code_inline", "parts": [{"type": "code", "value": "text = "}, {"type": "slot", "index": 0}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "print(text)"}]}]}',
...
VALUES (
    ...
    NULL,
    JSON_ARRAY('Go!Go!Go!'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "msg = \"Go!\""}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "print("}, {"type": "slot", "index": 0}, {"type": "code", "value": " "}, {"type": "slot", "index": 1}, {"type": "code", "value": ")"}]}]}',
    JSON_ARRAY('msg', '"Go!"', '*', '+', '**', '3'),
    JSON_ARRAY(1, 6),
    '字符串重复使用 *，所以需要 msg * 3。',
    '例如 "-" * 10 能画一条分隔线。'
