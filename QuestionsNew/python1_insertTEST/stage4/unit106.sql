...
-- Generated at 2025-12-24 18:14:27
...
VALUES (
    ...
    '1 2',
    JSON_ARRAY('2 4'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "lst = list(map(int, input().split()))"}, {"type": "code_line", "value": "res = map(lambda x: x*2, lst)"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "print(*list("}, {"type": "slot", "index": 0}, {"type": "code", "value": "))"}]}]}',
...
VALUES (
    ...
    '1 2 3',
    JSON_ARRAY('4 8'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "lst = list(map(int, input().split()))"}, {"type": "code_line", "value": "res = map(lambda x: x*2, lst)"}, {"type": "code_line", "value": "res2 = filter(lambda x: x%4==0, res)"}, {"type": "code_line", "value": "print(*list(res2))"}]}]}',
    JSON_ARRAY(),
    JSON_ARRAY(),
...
VALUES (
    ...
    '2 3 4',
    JSON_ARRAY('24'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "from functools import reduce"}, {"type": "code_line", "value": "from operator import mul"}, {"type": "code_line", "value": "lst = list(map(int, input().split()))"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "print(reduce("}, {"type": "slot", "index": 0}, {"type": "code", "value": ", lst))"}]}]}',
...
VALUES (
    ...
    '1 2 3 4',
    JSON_ARRAY('4 8'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "lst = list(map(int, input().split()))"}, {"type": "code_line", "value": "res = map(lambda x: x*2, filter(lambda x: x%2==0, lst))"}, {"type": "code_line", "value": "print(*list(res))"}]}]}',
    JSON_ARRAY(),
    JSON_ARRAY(),
...
3 4',
    JSON_ARRAY('4 6'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "a = list(map(int, input().split()))"}, {"type": "code_line", "value": "b = list(map(int, input().split()))"}, {"type": "code_line", "value": "print(*list(map(lambda x,y: x+y, a, b)))"}]}]}',
    JSON_ARRAY(),
    JSON_ARRAY(),
