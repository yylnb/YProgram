...
-- Generated at 2025-12-24 18:07:34
...
VALUES (
    ...
    '1 2',
    JSON_ARRAY('2 1'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "s=[]"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "for x in input().split():"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "    s.append(int(x))"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "while s:"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "    print(s.pop(), end=\" \")"}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
...
VALUES (
    ...
    '1 2',
    JSON_ARRAY('1 2'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "from collections import deque"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "q=deque(map(int,input().split()))"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "while q:"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "    print(q.popleft(), end=\" \")"}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
...
VALUES (
    ...
    '1 5 3 4',
    JSON_ARRAY('5 4 3'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "import heapq"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "arr=list(map(int,input().split()))"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "print(heapq.nlargest(3, arr))"}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
...
VALUES (
    ...
    '3 1 2',
    JSON_ARRAY('1'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "import heapq"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "arr=list(map(int,input().split()))"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "heapq.heapify(arr)"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "print(heapq.heappop(arr))"}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
...
VALUES (
    ...
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "from collections import deque"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "q=deque(maxlen=3)"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "for x in input().split():"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "    q.append(x)"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "print(*q)"}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
