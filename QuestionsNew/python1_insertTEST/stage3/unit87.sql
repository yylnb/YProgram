...
-- Generated at 2025-12-24 18:08:07
...
VALUES (
    ...
    'abc123',
    JSON_ARRAY('123'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "import re"}, {"type": "code_line", "value": "m=re.search(r\"\\d+\", input().strip())"}, {"type": "code_block", "lines": [{"type": "code_line", "value": "if m:"}, {"type": "code_line", "value": "    print(m.group())"}]}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
...
a',
    JSON_ARRAY('0 2'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "import re"}, {"type": "code_line", "value": "s=input().strip()"}, {"type": "code_block", "lines": [{"type": "code_line", "value": "for m in re.finditer(\"a\", s):"}, {"type": "code_line", "value": "    print(m.start(), end=\" \")"}]}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
