...
-- Generated at 2025-12-24 18:08:53
...
VALUES (
    ...
    NULL,
    JSON_ARRAY('(none)'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "if step % 1000 == 0:"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "    "}, {"type": "slot", "index": 0}, {"type": "code", "value": "(state)"}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
