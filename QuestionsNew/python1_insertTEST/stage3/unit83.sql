...
-- Generated at 2025-12-24 18:07:20
...
VALUES (
    ...
    '1 2 3',
    JSON_ARRAY('1 2'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "from itertools import islice"}, {"type": "code_line", "value": "import sys"}, {"type": "code_line", "value": "it=map(int, sys.stdin.read().split())"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "print(list(islice(it,"}, {"type": "slot", "index": 0}, {"type": "code", "value": ")))"}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
...
VALUES (
    ...
    '补全：对按第一个字符分组的简单示例。',
    'a1 a2 b1',
    JSON_ARRAY('group a: a1 a2
group b: b1'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "from itertools import groupby"}, {"type": "code_line", "value": "arr=input().split()"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "for k,g in groupby(sorted(arr, key=lambda x: x[0]), key=lambda x: x[0]):"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "    print(\"group\", k, \":\", *list(g"}, {"type": "slot", "index": 0}, {"type": "code", "value": "))"}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
...
e f',
    ...
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "import itertools"}, {"type": "code_line", "value": "a=input().split()"}, {"type": "code_line", "value": "b=input().split()"}, {"type": "code_line", "value": "c=input().split()"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "for x in itertools.chain(a,b,c):"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "    print(x, end=\""}, {"type": "slot", "index": 0}, {"type": "code", "value": "\")"}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
...
VALUES (
    ...
    '1 a 2 b',
    JSON_ARRAY('a b'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "from itertools import filterfalse"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "print(*filterfalse(lambda x: x.isdigit(), input().split()"}, {"type": "slot", "index": 0}, {"type": "code", "value": "))"}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
