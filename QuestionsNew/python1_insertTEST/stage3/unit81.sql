...
-- Generated at 2025-12-24 18:06:28
...
VALUES (
    ...
    '1 2 3',
    JSON_ARRAY('3 2 1'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "for x in reversed(list(map(int,input().split()))):"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "    print(x, end=\""}, {"type": "slot", "index": 0}, {"type": "code", "value": "\")"}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
