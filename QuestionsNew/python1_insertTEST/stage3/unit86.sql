...
-- Generated at 2025-12-24 18:08:05
...
b',
    JSON_ARRAY('1'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "s=input().strip()"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "sub=input().strip()"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "print(s.find(sub))"}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
    'find 返回首次出现的索引或 -1。',
    's.find(sub)'
...
ll',
    JSON_ARRAY('Yes'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "s=input().strip()"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "sub=input().strip()"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "print(\"Yes\" if sub in s else \"No\")"}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
    'in 用于判断子串存在性并返回布尔值。',
    'if sub in s:'
...
ab',
    JSON_ARRAY('0 2 4'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "s=input().strip(); sub=input().strip();"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "pos= s.find(sub)"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "res=[]"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "while pos!=-1:"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "    res.append(str(pos))"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "    pos = s.find(sub, pos+1)"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "print(\" \".join(res))"}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
...
ab',
    JSON_ARRAY('0 2'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "import re"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "s=input().strip()"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "sub=input().strip()"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "print(\" \".join([str(m.start()) for m in re.finditer(\"(?={})\".format(re.escape(sub)), s)]))"}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
