...
-- Generated at 2025-12-24 18:02:45
...
VALUES (
    ...
    NULL,
    JSON_ARRAY(),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "if invalid:"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "    # skip invalid entries"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "    "}, {"type": "slot", "index": 0}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
...
VALUES (
    ...
    NULL,
    JSON_ARRAY(),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "if cond_skip:"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "    "}, {"type": "slot", "index": 0}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "elif cond_exit:"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "    break"}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
