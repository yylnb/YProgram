...
-- Generated at 2025-12-24 18:01:03
...
VALUES (
    ...
    NULL,
    JSON_ARRAY('1', '2', '3'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "i = 1"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "while i <= 3:"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "    print(i)"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "    i += 1"}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
    '使用计数器控制循环次数。',
    'i=0; while i<3: ...'
...
VALUES (
    ...
    NULL,
    JSON_ARRAY(),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "i = 0"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "while i < 3:"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "    print(i)"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "    # missing i += 1"}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
    '未改变循环变量会导致无限循环。',
    '确保循环变量更新'
...
VALUES (
    ...
    'quit',
    JSON_ARRAY(),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "while True:"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "    s = input()"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "    if s == \"quit\":"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "        break"}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
    '通过判断输入并 break 退出循环。',
    'if s=="q": break'
...
VALUES (
    ...
    NULL,
    JSON_ARRAY(),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "i = 0"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "while cond:"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "    do_work()"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "    i += 1"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "    if i > 1000:"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "        break"}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
    '安全计数可防止意外的长期运行。',
    'max_iters guard'
...
VALUES (
    ...
    NULL,
    JSON_ARRAY(),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "running = True"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "while running:"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "    cmd = input()"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "    if cmd == \"exit\":"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "        running = False"}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
    '用布尔变量控制循环状态是常见模式。',
