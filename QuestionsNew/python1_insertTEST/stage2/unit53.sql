USE `questions`;
-- Unit 53 | Start ID: 1231
-- Generated at 2025-12-24 17:37:00
...
VALUES (
    ...
    'a=3 b=7',
    JSON_ARRAY('5'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "a = int(input())"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "b = int(input())"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "print(b - a + 1)"}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
    '闭区间整数个数为 b-a+1。',
    '若 a==b，则为 1'
