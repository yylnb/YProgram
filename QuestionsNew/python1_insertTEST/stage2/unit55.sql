USE `questions`;
-- Unit 55 | Start ID: 1261
-- Generated at 2025-12-24 17:36:49
...
VALUES (
    ...
    's=abc',
    JSON_ARRAY('invalid'),
    '{"segments": [{"type": "code_block", "lines": [{"type": "code_line", "value": "try:"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "    n = int(input())"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "except ValueError:"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "    print(\"invalid\")"}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
...
VALUES (
    ...
    'name=""',
    JSON_ARRAY('invalid'),
    '{"segments": [{"type": "code_inline", "parts": [{"type": "code", "value": "name = input().strip()"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "if not name:"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "    print(\"invalid\")"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "else:"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "    open(name)"}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
...
VALUES (
    ...
    's="a\'*150+\'"',
    JSON_ARRAY(''),
    '{"segments": [{"type": "code_inline", "parts": [{"type": "code", "value": "s = input()"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "if len(s) > 100:"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "    s = s[:100]"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "print(s)"}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
...
VALUES (
    ...
    'c="yes"',
    JSON_ARRAY('accepted'),
    '{"segments": [{"type": "code_inline", "parts": [{"type": "code", "value": "c = input().strip()"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "if c in (\"yes\",\"no\"):"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "    print(\"accepted\")"}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "else:"}]}, {"type": "code_inline", "parts": [{"type": "code", "value": "    print(\"rejected\")"}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
    '白名单可以避免非法或意外输入导致问题。',
...
VALUES (
    ...
    '',
    JSON_ARRAY('en'),
    '{"segments": [{"type": "code_inline", "parts": [{"type": "code", "value": "locale = input().strip() or \"en\""}]}, {"type": "code_block", "lines": [{"type": "code_line", "value": "print(locale)"}]}]}',
    JSON_ARRAY('示例已给出'),
    JSON_ARRAY(0),
    '使用 or 提供默认值是常见简洁写法。',
    'value = x or default'
