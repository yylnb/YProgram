...
const props = defineProps({
  simResolution: { type: Number, required: false, default: 128 },
  dyeResolution: { type: Number, required: false, default: 1440 },
  captureResolution: { type: Number, required: false, default: 512 },
  densityDissipation: { type: Number, required: false, default: 3.5 },
  velocityDissipation: { type: Number, required: false, default: 2 },
  pressure: { type: Number, required: false, default: 0.1 },
  pressureIterations: { type: Number, required: false, default: 20 },
  curl: { type: Number, required: false, default: 3 },
  splatRadius: { type: Number, required: false, default: 0.2 },
  splatForce: { type: Number, required: false, default: 6000 },
  shading: { type: Boolean, required: false, default: true },
  colorUpdateSpeed: { type: Number, required: false, default: 10 },
  backColor: {
    type: Object,
    required: false,
